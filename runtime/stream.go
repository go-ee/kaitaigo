...
// ReadU1le reads 1 byte and returns this as uint8.
func (k *Stream) ReadU1le() (v uint8, err error) {
	return k.ReadU1()
}
...
func (k *Stream) ReadBytes(n uint16) (b []byte, err error) {
	if n < 0 {
...
// ReadBytesString reads n bytes and returns those as a byte array.
func (k *Stream) ReadBytesString(n uint16) (ret string, err error) {
	var data []byte
	if data, err = k.ReadBytes(n); err == nil {
		ret = string(data)
	}
	return
}
...
// ReadBytesFullString reads all remaining bytes and returns those as a byte array.
func (k *Stream) ReadBytesFullString() (ret string, err error) {
	var data []byte
	if data, err = ioutil.ReadAll(k); err == nil {
		ret = string(data)
	}
	return
}
...
func (k *Stream) ReadBytesPadTerm(size uint16, term, pad byte, includeTerm bool) ([]byte, error) {
...
func (k *Stream) ReadB1le() (res uint, err error) {
	var value uint64
	if value, err = k.ReadBitsIntLe(1); err == nil {
		res = uint(value)
	}
	return
}

func (k *Stream) ReadB1be() (res uint, err error) {
	var value uint64
	if value, err = k.ReadBitsIntBe(1); err == nil {
		res = uint(value)
	}
	return
}

func (k *Stream) ReadB6le() (res uint64, err error) {
	res, err = k.ReadBitsIntLe(6)
	return
}

func (k *Stream) ReadB6be() (res uint64, err error) {
	res, err = k.ReadBitsIntBe(6)
	return
}

func (k *Stream) ReadB1leBool() (res bool, err error) {
	var value uint64
	if value, err = k.ReadBitsIntLe(1); err == nil {
		res = value != 0
	}
...
func (k *Stream) ReadB1beBool() (res bool, err error) {
	var value uint64
	if value, err = k.ReadBitsIntBe(1); err == nil {
		res = value != 0
	}
...
func (k *Stream) ReadB2le() (res uint, err error) {
	var value uint64
	if value, err = k.ReadBitsIntLe(2); err == nil {
		res = uint(value)
	}
	return
}

func (k *Stream) ReadB2be() (res uint, err error) {
	var value uint64
	if value, err = k.ReadBitsIntBe(2); err == nil {
		res = uint(value)
	}
	return
}

func (k *Stream) ReadB4le() (res uint64, err error) {
	res, err = k.ReadBitsIntLe(4)
	return
}

func (k *Stream) ReadB4be() (res uint64, err error) {
	res, err = k.ReadBitsIntBe(4)
	return
}
